...
const PromptIcon = ({ icon }) => (
  <span className="text-accent-cyan group-hover:text-primary-600 transition-colors">
    {icon}
  </span>
);
      ...
      <div className="grid grid-cols-2 gap-2">
        {prompts.map((prompt) => (
          <button
            ...
            className="flex items-center gap-2 px-3 py-2.5 glass hover:bg-primary-50/50 rounded-xl text-xs font-medium text-gray-600 transition-all duration-200 group"
          >
