    ...
    <div className="min-h-screen py-8 rounded-[2rem] mx-2 sm:mx-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="bento-card-glass p-6 animate-tilt-in" style={{ animationDelay: '0s' }}>
          ...
          <div className="bento-card-glass p-6 animate-tilt-in" style={{ animationDelay: '0.1s' }}>
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="bento-card-glass p-6 animate-tilt-in" style={{ animationDelay: '0.2s' }}>
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="bento-card-glass p-6 animate-tilt-in" style={{ animationDelay: '0.3s' }}>
            <div className="flex items-center justify-between">
              <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-accent-cyan via-primary-500 to-accent-violet rounded-2xl p-6 text-white">
            ...
            <div className="bento-card-glass p-6">
              ...
              <div className="relative pt-1">
                ...
                <div className="overflow-hidden h-2 mb-4 text-xs flex rounded-full bg-white/20">
                  <div
                    style={{ width: `${user?.skills ? 85 : 40}%` }}
                    className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-gradient-to-r from-accent-cyan to-primary-500 rounded-full"
                  ></div>
                </div>
                <Link to="/profile" className="text-primary-600 text-sm hover:text-primary-500">
