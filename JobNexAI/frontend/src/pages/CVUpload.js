...
const CVUpload = () => {
  ...
  return (
    <div className="min-h-screen py-8 rounded-[2rem] mx-2 sm:mx-4">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bento-card-glass p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Upload Resume</h2>
            
            {!file ? (
              <div
                {...getRootProps()}
                className={`bento-card-glass border-2 border-dashed p-6 sm:p-12 text-center cursor-pointer transition-all duration-300 ${
                  dragActive ? 'border-accent-cyan/50 bg-accent-cyan/5' : 'border-white/30 hover:border-primary-400'
                }`}
                onDragEnter={() => setDragActive(true)}
                onDragLeave={() => setDragActive(false)}
              >
                <input {...getInputProps()} />
                <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-accent-cyan/20 to-accent-violet/20 rounded-2xl flex items-center justify-center">
              ...
              <div className="glass-strong rounded-2xl p-6">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 bg-red-100/80 rounded-lg flex items-center justify-center">
                ...
                <div className="flex gap-4">
                  ...
                  >
                    {analyzing ? (
                      <>
                        <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white text-primary-500"></div>
                        Analyzing...
                      </>
                    ) : (
                      <>
          ...
          <div className="bento-card-glass p-6">
            ...
            <div className="space-y-4">
              <div className="glass rounded-xl p-4 flex items-start gap-4">
                <div className="w-10 h-10 bg-primary-100/80 rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <div className="glass rounded-xl p-4 flex items-start gap-4">
                <div className="w-10 h-10 bg-secondary-100/80 rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <div className="glass rounded-xl p-4 flex items-start gap-4">
                <div className="w-10 h-10 bg-green-100/80 rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <div className="glass rounded-xl p-4 flex items-start gap-4">
                <div className="w-10 h-10 bg-orange-100/80 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        {analysis && (
          <div className="mt-8 bento-card-glass p-6">
