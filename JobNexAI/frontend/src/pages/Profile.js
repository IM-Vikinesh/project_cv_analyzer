    ...
    <div className="min-h-screen py-8 rounded-[2rem] mx-2 sm:mx-4">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bento-card-glass p-4 sm:p-8">
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 mb-8 pb-6 sm:pb-8 border-b border-white/20">
            <div className="relative group cursor-pointer" onClick={handleImageClick}>
              ...
              <div className="absolute inset-0 bg-white/70 backdrop-blur-sm rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                {uploadingImage ? (
        ...
        <div className="mt-8 bento-card-glass p-4 sm:p-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 glass rounded-xl bg-red-500/5 border-red-500/20">
              <div>
                <h4 className="font-medium text-red-900">Delete Account</h4>
                <p className="text-sm text-red-600">Permanently delete your account and data</p>
              </div>
              <button className="px-4 py-2 border border-red-300 text-red-500 rounded-xl hover:bg-red-50 transition-colors text-sm">
                Delete Account
              </button>
            </div>
          </div>
